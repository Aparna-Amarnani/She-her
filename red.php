 ...
 <div class="sidenav">
    ...
    <div class="main">
        ...
        <h2>Do not Panic! We are there for you</h2>
            ...
            <div id="task">
                To share location with the registered family member
                ...
                <p>To Call women help line number <a href="tel:	1091">Click Here</a></p>
            </div>
            </div>
    </div>
...
<?php
$loc=$_COOKIE['loc'];
mysqli_query($conn,"UPDATE location set lat='$loc' WHERE User_ID='$us'");
mysqli_query($conn,"UPDATE location set lon='$loc' WHERE User_ID='$us'");
?>