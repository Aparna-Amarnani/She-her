...
<body>
    <div class="sidenav">
        ...
        <a href="main.php?id=<?php echo $us;?>">Home</a>
        <a href="red.php?id=<?php echo $us; ?>">Red Mode</a>
        <a href="green.php?id=<?php echo $us;?>">Green Mode</a>
    </div>
    <div class="main">
        <h1>Yellow Mode</h1>
        ...
        <div id="split">
                ...
                <div id="task"> Call to the registered emergency number
                <a href="tel:
                <?php 
                $servername="localhost";
                $username="root";
